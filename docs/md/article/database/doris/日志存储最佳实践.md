...
### 第 2 步：部署集群[](https://doris.apache.org/zh-CN/docs/log-storage-analysis#第-2-步部署集群)

完成资源评估后，可以开始部署 Apache Doris 集群，推荐在物理机及虚拟机环境中进行部署。手动部署集群，可参考 [手动部署](https://doris.apache.org/zh-CN/docs/install/deploy-manually/integrated-storage-compute-deploy-manually)。

### 第 3 步：优化 FE 和 BE 配置[](https://doris.apache.org/zh-CN/docs/log-storage-analysis#第-3-步优化-fe-和-be-配置)
...
更多关于 FE 配置项的信息，可参考 [FE 配置项](https://doris.apache.org/zh-CN/docs/admin-manual/config/fe-config)。
...
更多关于 BE 配置项的信息，可参考 [BE 配置项](https://doris.apache.org/zh-CN/docs/admin-manual/config/be-config)。

### 第 4 步：建表[](https://doris.apache.org/zh-CN/docs/log-storage-analysis#第-4-步建表)
...
- 使用时间字段上的 (./table-design/data-partitioning/manual-partitioning.md#range-分区) (`PARTITION BY RANGE(`ts`)`)，并开启 [动态分区](https://doris.apache.org/zh-CN/docs/table-design/data-partitioning/dynamic-partitioning) (`"dynamic_partition.enable" = "true"`)，按天自动管理分区。
...
更多关于分区分桶的信息，可参考 [数据划分](https://doris.apache.org/zh-CN/docs/table-design/data-partitioning/basic-concepts)。
...
### 第 5 步：采集日志[](https://doris.apache.org/zh-CN/docs/log-storage-analysis#第-5-步采集日志)
...
更多关于 Logstash 配置和使用的说明，可参考 [Logstash Doris Output Plugin](https://doris.apache.org/zh-CN/docs/ecosystem/logstash)。
...
更多关于 Filebeat 配置和使用的说明，可参考 [Beats Doris Output Plugin](https://doris.apache.org/zh-CN/docs/ecosystem/beats)。
...
更多关于 Kafka 配置和使用的说明，可参考 [Routine Load](https://doris.apache.org/zh-CN/docs/data-operate/import/import-way/routine-load-manual)。
...
### 第 6 步：查询和分析日志[](https://doris.apache.org/zh-CN/docs/log-storage-analysis#第-6-步查询和分析日志)
