...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/29236088/1677824948632-47e0c41c-3cb4-4408-8ff8-3ae459bbe756.png#averageHue=%23f4f3f4&clientId=ubefa1022-28d2-4&id=qxzFu&name=image.png&originHeight=288&originWidth=774&originalType=binary&ratio=1&rotation=0&showTitle=false&size=18065&status=done&style=none&taskId=ucfb5e705-fae9-4633-aa31-20b488eec84&title=)
...
在 **jdk1.6 之后** Java 官方对从 JVM 层面对 synchronized 较大优化，所以现在的 synchronized 锁效率也优化得很不错了，Jdk1.6 之后，为了减少获得锁和释放锁所带来的性能消耗，引入了偏向锁和轻量级锁，**增加了锁升级的过程**，由无锁->偏向锁->自旋锁->重量级锁 ![image.png](https://cdn.nlark.com/yuque/0/2023/png/29236088/1675687052049-ef2ad665-a5b2-4845-9565-4e19613f7568.png#averageHue=%23f9f9f9&clientId=u00400ee8-e274-4&from=paste&id=ucbace034&name=image.png&originHeight=650&originWidth=1188&originalType=url&ratio=1&rotation=0&showTitle=false&size=361660&status=done&style=none&taskId=u83be01ee-cd90-4b67-a772-95453bd41c7&title=)
...
流程图如下:
![image.png](https://cdn.nlark.com/yuque/0/2023/png/29236088/1675687051874-faa73eb9-9a6a-4678-bbea-e0b517629b14.png#averageHue=%23f7f7f7&clientId=u00400ee8-e274-4&from=paste&id=uaa1c338b&name=image.png&originHeight=646&originWidth=1808&originalType=url&ratio=1&rotation=0&showTitle=false&size=185410&status=done&style=none&taskId=u13b68d7b-3637-491c-bff0-46ad3237caa&title=)
