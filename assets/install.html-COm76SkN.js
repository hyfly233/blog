import{_ as s,c as n,o as a,e}from"./app-C8k0y3B3.js";const l={},i=e(`<h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料"><span>参考资料</span></a></h2><ul><li><a href="https://www.zabbix.com/download?zabbix=5.0&amp;os_distribution=centos&amp;os_version=7&amp;components=server_frontend_agent&amp;db=mysql&amp;ws=apache" target="_blank" rel="noopener noreferrer">官方下载 Zabbix</a></li></ul><h2 id="安装-zabbix-server" tabindex="-1"><a class="header-anchor" href="#安装-zabbix-server"><span>安装 Zabbix Server</span></a></h2><h3 id="关闭-selinux" tabindex="-1"><a class="header-anchor" href="#关闭-selinux"><span>关闭 Selinux</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># step.1</span></span>
