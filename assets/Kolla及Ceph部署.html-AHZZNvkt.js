import{_ as s,c as n,o as a,e}from"./app-C8k0y3B3.js";const l={},i=e(`<h2 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置"><span>基础配置</span></a></h2><ul><li>CentOS 7.4 x86</li><li>Kolla-ansible Train</li><li>Ceph-ansible stable-4.0</li></ul><h2 id="基础环境配置" tabindex="-1"><a class="header-anchor" href="#基础环境配置"><span>基础环境配置</span></a></h2><h3 id="安装基础软件" tabindex="-1"><a class="header-anchor" href="#安装基础软件"><span>安装基础软件</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># step.1 设置 yun 源</span></span>
